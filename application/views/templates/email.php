...
<div style="padding: 7px; border: 2px solid; font-family: 'Lato', sans-serif; line-height: 1.231; font-size: 14px; border-color: #F39C12; padding-right: 20px;">
	...
	{unwrap}<a href="<?php echo 'http://192.81.218.182/eupeval/index.php/welcome/activate/'.$key.'/'?>" style="color: #F39C12; text-decoration: none;"><?php echo 'http://192.81.218.182/eupeval/index.php/welcome/activate/'.$key.'/'?></a><br/><br/>{/unwrap}
